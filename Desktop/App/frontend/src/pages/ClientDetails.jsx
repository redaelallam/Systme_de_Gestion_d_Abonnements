...
const ClientDetails = () => {
  ...
  // تحديث دالة التجديد: تغيير حالة القديم وإضافة الجديد
  const handleRenew = useCallback(
      ...
      try {
        ...
        setLocalClient((p) => ({
          ...
          abonnements: [
            newSub,
            ...p.abonnements.map((s) =>
              s.id === renewModal.sub.id ? { ...s, statut: "Expiré" } : s,
            ),
          ],
        }));
    ...
    [renewForm, renewModal.sub, t],
  );

  // إضافة دالة الإلغاء الجديدة
      ...
      >
        <form onSubmit={handleRenew} className="space-y-4">
          <div className="bg-primary/10 border border-primary/20 p-3 rounded-lg mb-4 text-sm text-primary">
            ...
            <strong>nouveau dossier</strong> pour préserver l'historique
            financier.
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2">
                ...
                <table className="w-full text-left border-collapse">
                  ...
                  <tbody className="divide-y divide-border">
                    {sortedSubs.map((sub) => {
                      ...
                      // حماية: لا يمكن تعديل أو إيقاف أو إلغاء اشتراك انتهى أو تم إلغاؤه بالفعل
